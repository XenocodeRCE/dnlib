...
namespace dnlib.DotNet {
    ...
    public static class ModuleDefHelper{
        ...
        /// <summary>
        /// Gets all the app types (including nested types) except global type
        /// </summary>
        public static IEnumerable<TypeDef> GetTypes(this ModuleDefMD mod, bool b = true) {
            var curatedlist = new List<TypeDef>();
            foreach (var item in mod.GetTypes()) {
                if (item.IsGlobalModuleType) continue;
